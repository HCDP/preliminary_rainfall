...
if(!is.null(hads) && hads!="error"){  #did HADS month file exist? 
...
if(!is.null(nws) && nws!="error"){  #did nws month file exist? 
...
if(!is.null(scan) && scan!="error"){  #did scan month file exist? 
 #subset 24hr obs
...
if(!is.null(madis) && madis!="error"){  #did madis month file exist? 
...
if(!is.null(synoptic) && synoptic!="error"){  #did synoptic month file exist? 
