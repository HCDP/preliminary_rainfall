...
nws_24hr_agg_final<-ddply(nws_hrly_data_final_cc, .(nwsli,NWS_name, date), summarize, prec_mm_24hr = sum(prec_mm_1hr), hour_count=length(nwsli)) #sum by station & day and count hourly obs per station & day
